        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?= menu()['controller']; ?>/add" method="post">
                    ...
                    <div class="input-group input-group-sm mb-2">
                        <span style="width: 100px;" class="input-group-text">Nama</span>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?= menu()['controller']; ?>/update" method="post">
                        ...
                        <div class="input-group input-group-sm mb-2">
                            <span style="width: 100px;" class="input-group-text">Nama</span>
                            <input type="text" value="<?= $i['nama']; ?>" name="nama" placeholder="Nama" class="form-control" required>
                        </div>

                        <div class="input-group input-group-sm mb-2">
                            <span style="width: 100px;" class="input-group-text">Username</span>
                            <input type="text" value="<?= $i['username']; ?>" name="username" placeholder="Username" class="form-control" required>
                        </div>
